...
const SendMessage = () => {
    ...
    const showContent = searchParams.get('show') === 'true';
    ...
    const handleGoToUser = () => {
        if (usernameInput) {
            router.push(`/user/${usernameInput}?show=true`);
        }
    };
    ...
    }, [fetchSuggestedMessages, showContent]);
    ...
    return (
        <div className="flex items-center justify-center min-h-screen text-white">
            <div className="my-8 mx-4 md:mx-6 lg:mx-8 xl:mx-10 p-4 md:p-6 lg:p-8 bg-gray-800 text-white rounded w-full max-w-6xl">
                ...
                <div className="mb-10">
                    <p className="mb-2 text-slate-300">Enter a username to send a message:</p>
                    <div className="flex items-center gap-2">
                        <Input
                            ...
                            className="bg-slate-700 text-white border-slate-600 focus:ring-slate-500"
                        />
                        <Button onClick={handleGoToUser} className="bg-slate-700 text-white hover:bg-slate-600">
                            Go
                        </Button>
                    </div>
                </div>
